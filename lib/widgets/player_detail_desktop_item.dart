...
class PlayerDetailDesktopItem extends StatelessWidget {
  final playerModel.Player player;

  const PlayerDetailDesktopItem({Key? key, required this.player}) : super(key: key);
...
class StreakIcon2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      width: 3,
      decoration: BoxDecoration(
        color: enabled ? Color(0xff03CA45) : Color(0xffD1D6DE),
        borderRadius: BorderRadius.circular(5),
      ),
    );
  }
